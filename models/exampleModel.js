...
// This creates our model from the above schema, using mongoose's model method 1)Model going to use, 2)schema going to use and 3)mongodb collection going to use collection name option mongo will use lowercase pluralized version of the model name
